namespace BuildCarDatabase
{
    ...
    {
        public const string Query = @"SELECT BilID, Merker.MerkeNavn, Modeller.ModellNavn, " +
                                    ...
                                    "CONCAT(FORMAT(KilometerstandVedSalg / 1000, 0), '.', LPAD(KilometerstandVedSalg % 1000, 3, '0')) ELSE 'Ukjent' END, ' km') END AS KilometerstandVedSalg, " +
